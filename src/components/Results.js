...
export default function Results() {
    ...
    return(
        ...
        <main class="results resources">
            ...
            <h3>Mental health is a continuous journey and work in progress, which is why we urge you to use these general and identity-specific resources to support your mental health.</h3>
            <Row>
                <Col>
                        <Card className="mb-4">
                            <CardBody>
